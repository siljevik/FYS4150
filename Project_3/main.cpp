...
/////////////// problem 9
        ...
        double t_steps = ceil(t_tot/dt); // ceil()- returns smallest int value
...
for(int i=0; i<1; i++)
{
        ...
        {
            datafile << "," << setprecision(prec) << f_list(i)
            << "," << setprecision(prec) << f(0)
            << "," << setprecision(prec) << f(1)
            << "," << setprecision(prec) << f(2)
            << "," << setprecision(prec) << n_particles.col(0)(i)
            << "," << setprecision(prec) << n_particles.col(1)(i)
            << "," << setprecision(prec) << n_particles.col(2)(i)
            << endl;
        }
         datafile.close();

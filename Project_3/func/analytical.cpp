                              ...
                              double d, double t)
{
  ...
  double A_plus = (v_0 + w_plus * x_0) / (w_min - w_plus); // A_plus = (v_0 + w_min * x_0) / (w_min - w_plus); (changed)
  double A_min = - (v_0 + w_min * x_0) / (w_min - w_plus); // A_min = - (v_0 + w_plus * x_0) / (w_min - w_plus); (changed)
